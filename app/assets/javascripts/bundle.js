...
var _tree_node_index_container = __webpack_require__(27);

var _tree_node_index_container2 = _interopRequireDefault(_tree_node_index_container);
...
var _TreeNodeIndex = __webpack_require__(40);

var _TreeNodeIndex2 = _interopRequireDefault(_TreeNodeIndex);

var _tree_nodes_actions = __webpack_require__(70);
...
var mapDispatchToProps = function mapDispatchToProps(dispatch, ownProps) {
    return {
        ...
        requestUpdateToTreeNode: function requestUpdateToTreeNode(treeNode) {
            return dispatch((0, _tree_nodes_actions.requestUpdateToTreeNode)(treeNode));
        }
    };
};

exports.default = (0, _reactRedux.connect)(mapStateToProps, mapDispatchToProps)(_TreeNodeIndex2.default);
...
var TreeNodeIndex = function (_React$Component) {
    _inherits(TreeNodeIndex, _React$Component);
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(35), __webpack_require__(61)(module)))
...
exports.requestUpdateToTreeNode = exports.requestToCreateTreeNode = exports.requestAllTreeNodes = exports.RECEIVE_ALL_TREE_NODES = exports.RECEIVE_TREE_NODE = undefined;

var _tree_nodes_api = __webpack_require__(71);

var RECEIVE_TREE_NODE = exports.RECEIVE_TREE_NODE = 'RECEIVE_TREE_NODE';
var RECEIVE_ALL_TREE_NODES = exports.RECEIVE_ALL_TREE_NODES = 'RECEIVE_ALL_TREE_NODES';

var receiveTreeNode = function receiveTreeNode(treeNode) {
    return {
...
var receiveAllTreeNodes = function receiveAllTreeNodes(treeNodes) {
    return {
...
var requestAllTreeNodes = exports.requestAllTreeNodes = function requestAllTreeNodes() {
    return function (dispatch) {
        return (0, _tree_nodes_api.fetchAllTreeNodes)().then(function (fetchedTreeNodes) {
            return dispatch(receiveAllTreeNodes(fetchedTreeNodes));
        });
    };
};

var requestToCreateTreeNode = exports.requestToCreateTreeNode = function requestToCreateTreeNode(treeNode) {
    return function (dispatch) {
        return (0, _tree_nodes_api.postTreeNode)(treeNode).then(function (createdTreeNode) {
            return dispatch(receitveTreeNode(treeNode));
        });
    };
};

var requestUpdateToTreeNode = exports.requestUpdateToTreeNode = function requestUpdateToTreeNode(treeNode) {
    return function (dispatch) {
        return updateTreeNode(treeNode).then(function (updatedTreeNode) {
            return dispatch(receiveTreNode(updatedTreeNode));
        });
    };
};
...
var fetchAllTreeNodes = exports.fetchAllTreeNodes = function fetchAllTreeNodes() {
    return $.ajax({
        url: 'api/tree_nodes',
        method: 'GET'
    });
...
var postTreeNode = exports.postTreeNode = function postTreeNode(treeNode) {
    return $.ajax({
        url: 'api/tree_nodes',
        method: 'POST',
        data: {
...
var patchTreeNode = exports.patchTreeNode = function patchTreeNode(treeNode) {
    return $.ajax({
